		...
		<main className="pa4 black-80">
		  <div className="measure">
		    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
		      <legend className="f2 fw6 ph0 mh0 light-green">Register</legend>
		      <div className="mt3">
		        <label className="db fw6 lh-copy f6" htmlFor="name">Name</label>
		        <input className="pa2 input-reset b--light-green ba bg-transparent hover-bg-black hover-white w-100" type="text" name="name"  id="name"/>
		      </div>
		      <div className="mt3">
		    ...
		    <div className="">
		      ...
		      className="b pa2 input-reset ba b--black bg-light-green grow pointer f6 dib" 
		      type="submit" 
		      value="Register"
		      />
		    </div>
